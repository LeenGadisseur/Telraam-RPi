...
def schrijfCSV_gem_appart(gem, appart):
    ...
    #fw = open("output_gem_appart_thuis_pi4.csv", "a")
    #if(os.stat("output_gem_appart_thuis_pi4.csv").st_size == 0):
...
# Testfunctie: stringDataDump(): print data van de objecten van de dataframe af.
